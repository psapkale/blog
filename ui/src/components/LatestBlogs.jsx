...
export const LatestBlogs = () => {
   ...
   return (
      <div className="w-[66%] mx-auto mt-10 h-fit px-10">
         <div
            style={{
               color: theme === "light" ? "black" : "white",
            }}
            className="text-[12px] font-[600] flex items-center justify-between"
         >
         ...
         <div className="my-10 flex flex-col gap-6 items-start justify-evenly">
            {!blogs[0] ? (
               <div className="w-full text-[10px] text-center">loading..</div>
            ) : (
               blogs.map((blog) => {
